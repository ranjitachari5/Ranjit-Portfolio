...
import { SiGit, SiNumpy, SiHtml5, SiJavascript, SiTailwindcss, SiMysql, SiFastapi, SiCplusplus, SiPhp, SiSqlite, SiVite } from 'react-icons/si'
const Homepage = () => {
  return (
    <>
      <a
        href="/Ranjit.pdf"
        download="Ranjit_resume.pdf"
        aria-label="Download resume"
        className="fixed right-4 bottom-4 sm:right-6 sm:bottom-10 z-40 inline-flex items-center gap-2 rounded-full bg-green-800 px-4 py-3 text-sm font-semibold text-white font-serif shadow-lg ring-1 ring-white/20 transition hover:-translate-y-1 hover:bg-amber-600 hover:shadow-xl focus:outline-none focus:ring-2 "
      >
      ...
      <div className=" text-white font-serif pt-16 sm:pt-20 pb-10">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-center text-center md:text-left gap-8">
          <div>
            ...
            <p className="mt-4">Computer Science and Engineering student</p>
            <p className="mt-0">Focused on practical software development</p>
          </div>
          <img
      ...
      <div id="skills" className="bg-[#e2e4dc] text-green-800 font-serif pt-5 pb-10">
 ...
 <div className="flex flex-col items-start gap-4">
            ...
            <div className="flex flex-wrap gap-3 mt-1">
              ...
              <span className="w-12 h-12 rounded-full flex items-center justify-center border border-gray-300 hover:scale-110 transition" title="C++">
                <SiCplusplus className="w-6 h-6" />
              </span>

              <span className="w-12 h-12 rounded-full flex items-center justify-center border border-gray-300 hover:scale-110 transition" title="Java">
              ...
              <span className="w-12 h-12 rounded-full flex items-center justify-center border border-gray-300 hover:scale-110 transition" title="Matplotlib">
              ...
              <span className="w-12 h-12 rounded-full flex items-center justify-center border border-gray-300 hover:scale-110 transition" title="PHP">
                <SiPhp className="w-6 h-6" />
              </span>

              <span className="w-12 h-12 rounded-full flex items-center justify-center border border-gray-300 hover:scale-110 transition" title="SQLite">
              ...
              <span className="w-12 h-12 rounded-full flex items-center justify-center border border-gray-300 hover:scale-110 transition" title="Vite">
                <SiVite className="w-6 h-6" />
              </span>

              <span className="w-12 h-12 rounded-full flex items-center justify-center border border-gray-300 hover:scale-110 transition" title="VS Code">
